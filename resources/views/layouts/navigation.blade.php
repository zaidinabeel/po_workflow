            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.users.index')" :active="request()->routeIs('admin.*')">
                        <i class="fas fa-users" style="margin-right:6px"></i> {{ __('Admin Panel') }}
                    </x-nav-link>
                    @endif

                    @if(Auth::user()->role === 'super_admin')
                    <x-nav-link :href="route('superadmin.audit.index')" :active="request()->routeIs('superadmin.*')">
                        <i class="fas fa-shield-alt" style="margin-right:6px"></i> {{ __('Super Admin Security') }}
                    </x-nav-link>
                    @endif
                </div>
            </div>
